...
variable "set_encrypters_decrypters_for" {
  description = "Name of keys for which encrypters/decrypters will be set."
  type        = list(string)
  default     = []
}

variable "encrypters_decrypters" {
  description = "List of comma-separated owners for each key declared in set_encrypter_decrypters_for."
  type        = list(string)
  default     = []
}
